...
public class PostScanDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                postMainGateScan(name,number,category);
            }
        });
    }

    private void postMainGateScan(String name, String number, String category) {
        final Context ctx = PostScanDetails.this;
        progressDialog = new ProgressDialog(ctx);
        progressDialog.setMessage("Please wait while we Post Attendance..."); // Setting Message
        progressDialog.setTitle("COG"); // Setting Title
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER); // Progress Dialog Style Spinner
        progressDialog.show(); // Display Progress Dialog
        progressDialog.setCancelable(false);

        Call<User> call2 = apiInterface.verifyQrMainGate(ConstantString.key,number,ConstantString.password,category);
